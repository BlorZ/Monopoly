...
public class MonopolyBD {
	...
	static {
		...
		toutesLesCases.add(new Propriete(1, TypeCase.PROPRIETE, "Propriété", "Martigues", 600L, 100L, 0, new ArrayList<>(), 2));
		toutesLesCases.add(new Case(2, TypeCase.CASE_CAISSE_COMMUNAUTE, "Caisse de Communauté", new ArrayList<>()));
		toutesLesCases.add(new Propriete(3, TypeCase.PROPRIETE, "Propriété", "Bouchain", 600L, 1000L, 0, new ArrayList<>(), 2));
		...
		toutesLesCases.add(new Propriete(6, TypeCase.PROPRIETE, "Propriété", "Canton du Quesnoy", 1000L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(7, TypeCase.CASE_CHANCE, "Case Chance", new ArrayList<>()));
		toutesLesCases.add(new Propriete(8, TypeCase.PROPRIETE, "Propriété", "Les Barthes", 1000L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Propriete(9, TypeCase.PROPRIETE, "Propriété", "La Nourais", 1200L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(10, TypeCase.VISITE_PRISON, "Visite Prison", new ArrayList<>()));
		toutesLesCases.add(new Propriete(11, TypeCase.PROPRIETE, "Propriété", "La Rance", 1400L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Propriete(12, TypeCase.PROPRIETE, "Propriété", "Paimpol-Bréhat", 1400L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(13, TypeCase.BONUS_PRIME_ETAT, "Bonus de prime d'état", new ArrayList<>()));
		toutesLesCases.add(new Propriete(14, TypeCase.PROPRIETE, "Propriété", "Mafate", 1600L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(15, TypeCase.SAFE, "Case safe", new ArrayList<>()));
		toutesLesCases.add(new Propriete(16, TypeCase.PROPRIETE, "Propriété", "Metz-Chambière", 1800L, 1000L, 0, new ArrayList<>(), 4));
		toutesLesCases.add(new Case(17, TypeCase.CASE_CAISSE_COMMUNAUTE, "Caisse de Communauté", new ArrayList<>()));
		toutesLesCases.add(new Propriete(18, TypeCase.PROPRIETE, "Propriété", "Gardanne", 1800L, 1000L, 0, new ArrayList<>(), 4));
		...
		toutesLesCases.add(new Propriete(21, TypeCase.PROPRIETE, "Propriété", "Gouadeloupe", 2200L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(22, TypeCase.CASE_CHANCE, "Case Chance", new ArrayList<>()));
		toutesLesCases.add(new Propriete(23, TypeCase.PROPRIETE, "Propriété", "Soultz-Sous-Forêts", 2200L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Propriete(24, TypeCase.PROPRIETE, "Propriété", "Hatten-Rittorshoffen", 2400L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(25, TypeCase.SAFE, "Case safe", new ArrayList<>()));
		toutesLesCases.add(new Propriete(26, TypeCase.PROPRIETE, "Propriété", "Mirande", 2600L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Propriete(27, TypeCase.PROPRIETE, "Propriété", "Bordeaux-Lac", 2600L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(28, TypeCase.BONUS_PRIX_NOBEL, "Prix Nobel", new ArrayList<>()));
		toutesLesCases.add(new Propriete(29, TypeCase.PROPRIETE, "Propriété", "Blauvac", 2800L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(30, TypeCase.PRISON, "Zonzon", new ArrayList<>()));
		toutesLesCases.add(new Propriete(31, TypeCase.PROPRIETE, "Propriété", "Fessenheim", 3000L, 1000L, 0, new ArrayList<>(), 5));
		toutesLesCases.add(new Propriete(32, TypeCase.PROPRIETE, "Propriété", "Gravelines", 3000L, 1000L, 0, new ArrayList<>(), 5));
		toutesLesCases.add(new Case(33, TypeCase.CASE_CAISSE_COMMUNAUTE, "Caisse de Communauté", new ArrayList<>()));
		toutesLesCases.add(new Propriete(34, TypeCase.PROPRIETE, "Propriété", "Tricastin", 3200L, 1000L, 0, new ArrayList<>(), 5));
		...
		toutesLesCases.add(new Propriete(37, TypeCase.PROPRIETE, "Propriété", "GOLFECH", 3500L, 1000L, 0, new ArrayList<>(), 0));
		toutesLesCases.add(new Case(38, TypeCase.IMPOT_POLUTION, "Impôt de Polution", new ArrayList<>()));
		toutesLesCases.add(new Propriete(39, TypeCase.PROPRIETE, "Propriété", "Strasbourg", 4000L, 1000L, 0, new ArrayList<>(), 0));
